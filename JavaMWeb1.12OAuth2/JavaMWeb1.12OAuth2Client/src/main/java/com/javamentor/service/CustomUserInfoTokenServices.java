...
public class CustomUserInfoTokenServices implements ResourceServerTokenServices
{
			...
			throws AuthenticationException, InvalidTokenException
	{
		...
		{
			String googleName = (String) map.get("given_name");
			String googleLastName = (String) map.get("family_name");
			String googleUsername = (String) map.get("email");

			User user = restTemplateService.findOneByGoogleEmail(googleUsername);
			...
			user.setGoogleEmail(googleUsername);
